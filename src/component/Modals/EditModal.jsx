...
// const EditModal = ({ setEditModalVisible }) => {
...
//       // Perform any additional logic you need before uploading
...
//     } else {
//       // Handle case where either moduleTitle or uploadedMaterials is empty
...
//     // Set the index of the material being edited
//     setEditedMaterialIndex(index);
//     // Populate the form fields with the details of the material being edited
//     setModuleTitle(uploadedMaterials[index].moduleTitle);
...
//         <h2>{""}</h2>
//           <IoClose onClick={handleCloseModal} className="cursor-pointer" />
//         </div>
//         <>
...
//               value={materialTitle}
//               onChange={(event) => handleMaterialTitleChange(event, editedMaterialIndex)}
//               className="border border-gray-300 rounded-md py-2 px-3 text-sm text-gray-700 focus:outline-none focus:border-blue-500 placeholder:text-sm mt-2"
//             />
//           </div>
